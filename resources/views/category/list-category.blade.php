                            ...
                            <tbody>
                                ...
                                <tr>                                
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url("/admin/category/del/{$category->id}") }}" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> </a>
                                        <a href="{{ url("/admin/category/upd/{$category->id}") }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
